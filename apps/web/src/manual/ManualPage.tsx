    ...
    <div className="manual" id="top">
      ...
      <Section id="modes">
        ...
        <dl className="manual-terms">
          ...
          <dt>ラボ (モードA)</dt>
          <dd>
            全機能を使える画面です。ヘッダー右側に「Project」「生成」「資産ブラウザ」「キャラクター」「Workflow」が並び、動画・音楽・音声・合成の生成、画像の派生・スイープ、詳しい設定、候補のA/B比較が使えます。
          </dd>
        </dl>
      </Section>
      ...
      <Section id="manage">
        ...
        <dl className="manual-terms">
          <dt>Project</dt>
          <dd>
            作品の作成と整理をします。「新規Project」で作成し、「生成で使う」で生成画面の対象にします。使わなくなったものは「アーカイブ」や「ゴミ箱へ移動」で片付け、「復元」で戻せます。「★ お気に入り」にしたProjectは、選択欄で名前の先頭に★が付きます。
          </dd>
          <dt>資産ブラウザ</dt>
          <dd>
          ...
          <dt>キャラクター</dt>
          <dd>
            登場人物を「追加」で登録し、外見や衣装、声を設定します。登録したキャラクターの見た目をもとに生成すると、カットをまたいでも同じ人物に見えやすくなります。
          </dd>
          <dt>Workflow</dt>
          <dd>
